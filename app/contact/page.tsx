                ...
                <form action={submitInquiry}>
                    <div className="mx-[20%]  py-5">
                     ...
                     <div className="mx-[20%]  py-5">
                        ...
                        <input id="phone" className="block w-full border bg-gray-100 h-8" />
                    </div>

                     <div className="mx-[20%]  py-5">
                        <label htmlFor="email" className="block mb-3">Email</label>
                        <input id="email" className="block w-full border bg-gray-100 h-8" required/>
                    </div>

                     <div className="mx-[20%]  py-5">
                        <label htmlFor="subject" className="block mb-3">Subject title</label>
                        <input id="subject" className="block w-full border bg-gray-100 h-8" />
                    </div>

                     <div className="mx-[20%]  py-5">
                        <label htmlFor="inquiry" className="block mb-3">Inquiry</label>
                        <input id="inquiry" className="block w-full border bg-gray-100 h-[90px]" required/>
                    </div>
<div className='flex justify-center pt-7'>
 <button className='border py-3 px-5 rounded bg-gray-200 hover:bg-gray-700 hover:text-white' type="submit">Submit/送信</button>
</div>
