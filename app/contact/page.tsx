            ...
            <div className='w-full'>
                <form action={submitInquiry}>
                    <div className="mx-[20%]  py-5">
                        ...
                        <input id="name" name="name" className="block w-full border bg-gray-100 h-8 p-2" required />
                    </div>

                    <div className="mx-[20%]  py-5">
                        <label htmlFor="email" className="block mb-3"> Email / メールアドレス <span className="text-red-500">*</span></label>
                        <input id="email" name="email" className="block w-full border bg-gray-100 h-8 p-2" required />
                    </div>

                    <div className="mx-[20%]  py-5">
                        <label htmlFor="phone" className="block mb-3">  Phone / 電話番号 </label>
                        <input id="phone" name="phone" className="block w-full border bg-gray-100 h-8 p-2" />
                    </div>



                    <div className="mx-[20%]  py-5">
                        <label htmlFor="subject" className="block mb-3"> Subject / 件名 <span className="text-red-500">*</span></label>
                        <input id="subject" name="subject" required className="block w-full border bg-gray-100 h-8 p-2" />
                    </div>
